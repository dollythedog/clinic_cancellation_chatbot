...
def is_within_contact_hours(
    dt: datetime | None = None, start_hour: int = 8, end_hour: int = 20
) -> bool:
    """
...
def time_until(target: datetime, from_time: datetime | None = None) -> timedelta:
    """
...
def minutes_until(target: datetime, from_time: datetime | None = None) -> float:
    """
